      ...
      <!-- 주문서 타이틀 -->
       <div class="page-title-area">
        ...
        <button class="btn-close">
          <img src="/newall/assets/images/ico-close-white.svg" alt="닫기" class="ico-close">
        </button>
       </div>
      <!-- //주문서 타이틀 -->
        ...
        <div class="common-inner">
          ...
          <div class="order-content-body">
            ...
            <div class="no-order hidden">
              <img src="/newall/assets/images/ico-exclaim.svg" alt="" aria-hidden="true">
            ...
            <ul class="menu-list">
              <li class="menu-item">
                ...
                <button class="btn-delete">
                  <img src="/newall/assets/images/ico-close.svg" alt="삭제" class="ico-delete">
                </button>
              </li>
              ...
              <li class="agreement-item" :class="agreeItem.checked ? 'is-open' : '' " @click="onClickAgreeList(agreeItem)" v-for="agreeItem in agreementList">
                <div class="agreement-title">
                  ...
                  <button class="btn-toggle">
                    <img src="/newall/assets/images/ico-arrow-gray.svg" alt="">
                  </button>
                </div>
